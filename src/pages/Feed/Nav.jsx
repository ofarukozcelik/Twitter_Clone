            ...
            <div>
                {!user ? (
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <button onClick={() => signOut(auth)} className="flex justify-center items-center gap-2 md:text-[15px] p-1 bg-zinc-700 rounded text-xl transition hover:bg-zinc-900">
                            <BiSolidDoorOpen />
